...
class TIPBackbone(nn.Module):
    ...
    def forward(self, x: torch.Tensor, visualize=False, return_embeddings=False) -> torch.Tensor:
        x_i, x_t = x[0], x[1]
...
if __name__ == "__main__":
    ...
    args = DotDict({'model': 'vit_small', 'checkpoint': None,
                    ...
                    'multimodal_embedding_dim': 512, 'multimodal_transformer_num_layers': 4,
                    'imaging_pretrained': True, 'imaging_pretrained_name': 'deit_small_patch16_224-cd65a155.pth',
                    'imaging_pretrained_path': '/data/pretrained',
                    'img_size': 128, 'patch_size': 16, 'embedding_dim': 384, 'mlp_ratio': 4.0, 'num_heads': 6,
                    'depth': 12,
