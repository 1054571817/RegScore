...
class TabularDataset(Dataset):
    ...
    def __init__(self, data_path: str, labels_path: str, eval_train_augment_rate: float, corruption_rate: float,
                 train: bool, eval_one_hot: bool, field_lengths_tabular: str,
                 data_base: str, strategy: str = 'tip', missing_tabular: str = False, missing_strategy: str = 'value',
                 missing_rate: float = 0.0, augmentation_speedup: bool = False,
                 target: str = None, task: str = "classification"
                 ):
        ...
        if self.missing_tabular:
            ...
            missing_mask_path = join(data_base, 'missing_mask',
                                     f'{tabular_name}_{target}_{missing_strategy}_{missing_rate}.npy')
    ...
    def one_hot_encode(self, subject: torch.Tensor) -> torch.Tensor:
        ...
        for i in range(len(subject)):
            if self.field_lengths[i] == 1:
                ...
                out.append(
                    torch.nn.functional.one_hot(torch.clamp(subject[i], min=0, max=self.field_lengths[i] - 1).long(),
...
if __name__ == '__main__':
    dataset = TabularDataset(
        data_path='/data/UKBB/cardiac_segmentations/projects/SelfSuperBio/18545/final/cardiac_features_train_imputed_noOH_tabular_imaging_CAD_balanced_reordered.csv',
        eval_train_augment_rate=1.0,
        labels_path='/data/UKBB/cardiac_segmentations/projects/SelfSuperBio/18545/final/cardiac_labels_CAD_train_balanced.pt',
        corruption_rate=0.3, train=True, eval_one_hot=False,
        field_lengths_tabular='/data/UKBB/cardiac_segmentations/projects/SelfSuperBio/18545/final/tabular_lengths_reordered.pt',
        data_base='/data/UKBB/cardiac_segmentations/projects/SelfSuperBio/18545/final',
